...
class cTurret
{
    ...
    bool Spawn( Vec3 origin, float yawAngle, int team )
    {
        ...
        cEntity @body = @G_SpawnEntity( "turret_body" );
        ...
        cEntity @gun = @G_SpawnEntity( "turret_gun" );
        gun.type = ET_GENERIC;
        ...
        cEntity @flash = @G_SpawnEntity( "turret_flash" );
    ...
    void think()
    {
        ...
        cEntity @body = @this.bodyEnt;
        cEntity @gun = @this.gunEnt;
        cEntity @flash = @this.flashEnt;
...
void turret_flash_think( cEntity @self )
{
...
cTurret @ClientDropTurret( cClient @client )
{
    ...
    Vec3 dir, dir2, dir3, start, end;

    client.getEnt().angles.angleVectors( dir, dir2, dir3 );
